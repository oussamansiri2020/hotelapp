        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Add spa Type</h4>
                        </div>
                        <div class="content">
                            {!! Form::open(array('url' => 'admin/spa_type/', 'id' => 'spa_type-add-form','files' => true)) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cost" class="form-control border-input"
                                               placeholder="Ex: 500" value="{{ old('cost') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" rows="5" class="form-control border-input"
                                                  placeholder="Ex: The Royal Suite are the luxurious hotel spas you can book.">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="spa_service" id="spa_service" class="form-control">
                                            <option value="1"
                                                    @if (Input::old('spa_service') == '1') selected="selected" @endif>Available
                                            </option>
                                            <option value="0"
                                                    @if (Input::old('spa_service') == '0') selected="selected" @endif>
                                                Unavailable
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info btn-fill btn-wd">Add spa Type
                                </button>
                            </div>

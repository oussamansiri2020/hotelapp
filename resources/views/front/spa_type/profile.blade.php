...
@section('content')
    <!--TOP SECTION-->
    <div class="hp-banner"> <img src="{{'/storage/spa/'.$spa_type->image}}" alt=""> </div>
    <!--END HOTEL ROOMS-->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="inn-com-form">
                        {!! Form::open(array('url' => 'spa_type/'.$spa_type->id.'/book', 'class' => 'col s12')) !!}
                        ...
                        @endif
                            <div class="row">
                                <div class="col s12 avail-title">
                                    ...
                                    <p>The final price is calculated by giving {{$spa_type->discount_percentage}}% discount, adding {{config('app.service_charge_percentage')}}% service charge and adding {{config('app.vat_percentage')}}% VAT in the room's original price.</p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                <div class="input-field col s12 m4 l2">
                                    <input type="text" style="color: black" value="{{config('app.currency').$spa_type->cost }}" class="form-btn" disabled>
                                </div>
                                {{-- <div class="input-field col s12 m4 l2">
                                ...
                                <div class="input-field col s12 m4 l2">
                                <input type="datetime-local" id="form" name="arrival_date"
                    ...
                    <div class="row">
                        <div class="hp-section">
                            <div class="hp-sub-tit">
                                <h4><span>{{ $spa_type->name }}</span> Room</h4>
                            </div>
                            <div class="hp-amini">
                                <p>{{ $spa_type->description }}</p>
                            </div>
                        </div>
                    ...
                    <div class="hp-book hp-right-com">
                        <div class="hp-book-in">
                            ...
                            <ul>
                                ...
                                <li><a href="https://twitter.com/share?url={{ Request::url() }}&text={{ $spa_type->name }}" rel="me" title="Twitter" target="_blank"><i class="fa fa-twitter"></i> Tweet</a>
                                </li>
